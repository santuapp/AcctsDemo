 ...
 * @author pc144
 */
public class profit_loss_vertical_panel extends javax.swing.JPanel  implements ContainerListener{
      private final GridBagConstraints gridBagConstraints;
    int count = 1000;
    final JButton[][] labels=new JButton[count][5];
    /**
     * Creates new form profit_loss_vertical_panel
     */
    public profit_loss_vertical_panel() {
        initComponents();
